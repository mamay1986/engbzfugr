<FORM name='<?PHP echo $form->formName; ?>' action='<?PHP echo $form->formAction; ?>' method='<?PHP echo $form->formMethod; ?>' enctype='<?PHP echo $form->formEnctype; ?>'>
		...
		foreach ($form->elements as $id=>$elements){
			switch($elements->type){
				...
				case 'SUBMIT':
					...
					$input = "<button onclick="javascript: document.<?PHP echo $form->formName; ?>.submit();" class='fmk-button-admin f10'><div><div>";
