<FORM id='mainform' name='<?PHP echo $form->formName; ?>' action='<?PHP echo $form->formAction; ?>' method='<?PHP echo $form->formMethod; ?>' enctype='<?PHP echo $form->formEnctype; ?>'>
		...
		foreach ($form->elements as $id=>$elements){
			switch($elements->type){
				...
				case "HTML":
					...
					<tr>
						<?PHP echo $elements->name; ?><?PHP echo $elements->value; ?>
					</tr>
					<?
					break;
				case "HItdEN":
				...
				case 'SUBMIT':
					...
					$input = "<button onclick='javascript: document.forms["mainform"].submit()' class='fmk-button-admin f10'><div><div>";
